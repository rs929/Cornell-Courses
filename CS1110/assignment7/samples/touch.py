...
If your computer is one of the ones with High-DPI display
issues, this may not work properly.
...
class Touch(GameApp):
    ...
    Invariant: last is a Point2 or None if mouse was not
    down last frame
    ...
    def _determineState(self):
        ...
        This method checks for either the mouse being held
        down (continuously) or a double click.  The mouse
        is held down if neither touch nor last are None.
        A double click occurs if the mouse was pressed and
        released quickly twice in succession.
        """
...
if __name__ == '__main__':
    Touch(left=150,width=WINDOW_WIDTH,height=WINDOW_HEIGHT,fps=60.0).run()
